...
include("./nav.php");
  $sqlnum = "SELECT `value` FROM preferences WHERE `name`= 'NO_OF_DISHES_TO_SHOW'";
...
<body>
<h2 style = "color: #01B0F1;">Welcome to ABC Dishes </h3>
...
<?php
    ...
    <br>
    <h2 id = "directions">Latest Dishes</h2><br>
...
<body>
 ...
 <?php
    ...
    $sql4 = "SELECT `value` FROM `preferences` WHERE `name`= 'NO_OF_DISHES_TO_SHOW'";
    ...
    $sql2 = "SELECT `Name`, `Id`, `Image`, `Description` FROM `dishes` ORDER BY RAND() LIMIT $questNum"; //using this as the real one
    $sql3 = "SELECT `Image` FROM `dishes` ORDER BY RAND() LIMIT $questNum";
